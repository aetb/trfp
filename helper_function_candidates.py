...
def trolley_run_station_average(corrected_df):
    ...
    for st in range(72):
        ...
        baseline_time[st, 0:4] = sum(out_df.index.values)/summed_pts[st, 0]
        ...
        if station_edges_6_probe[st+1] > station_edges_6_probe[st]:
...
#                 J[1,4] = 0  # Turns off sextupole correction to n quad
            else: J = trfp.J_6_PROBE
#             J[0,4] = 0  # Turns off sextupole correction.
