...
class Geometry(object):
    ...
    """This class generates values of various geoetric parameters.
    """

    def __init__(self):
        self.fp_x4 = np.array([0, 3, 0, 3])
        self.fp_y4 = np.array([7.7, 7.7, -7.7, -7.7])
        self.fp_x6 = np.array([-3, 0, 3, -3, 0, 3])
        self.fp_y6 = np.array([7.7, 7.7, 7.7, -7.7, -7.7, -7.7])

        self.tr_x = np.array([0]
                             + [1.75 * np.sin(2*np.pi/4*i)
                                for i in np.arange(4)]
                             + [3.5 * np.sin(2*np.pi/12*i)
                                for i in np.arange(12)])
        self.tr_y = np.array([0]
                             + [-1.75 * np.cos(2*np.pi/4*i)
                                for i in np.arange(4)]
                             + [-3.5 * np.cos(2*np.pi/12*i)
                                for i in np.arange(12)])

        self.station_ring_phi = [348, 352, 358, 3, 8, 12, 18, 22, 28,
        ...
        self.station_probe_id = [[0, 1, 2, 18, 19, 20],  # 0
                                 [3, 4, 5, 21, 22, 23],  # 1
                                 [6, 7, 8, 24, 25, 26],  # 2
                                 [9, 10, 11, 27, 28, 29],  # 3
                                 [12, 13, 14, 30, 31, 32],  # 4
